...
INPUT_SETS   = "lista_jogos_sets_masc.csv"
INPUT_JOGOS  = "lista_jogos_masc.csv"
OUTPUT       = "df_consolidado_saida_masc.csv"
...
FILES = {
    "RECEPCAO":     Path("recepcao_masc.csv"),
    "SAQUE":        Path("saque_masc.csv"),
    "LEVANTAMENTO": Path("levantamento_masc.csv"),
    "DEFESA":       Path("defesa_masc.csv"),
    "BLOQUEIO":     Path("bloqueio_masc.csv"),
    "ATAQUE":       Path("ataque_masc.csv"),
}
