...
WAIT_SECONDS = 15.0  # adjust if needed
...
def main():
    dados_competicoes = [{"COMPETICAO":"VNL","ANO":2021,"CATEGORIA":"F","PARTIDA_INI":11830,"PARTIDA_FIM":11953,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/volleyball-nations-league/2021/schedule/"},
                         {"COMPETICAO":"VNL","ANO":2022,"CATEGORIA":"F","PARTIDA_INI":13754,"PARTIDA_FIM":13857,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/volleyball-nations-league/2022/schedule/"},
                         {"COMPETICAO":"VNL","ANO":2023,"CATEGORIA":"F","PARTIDA_INI":16024,"PARTIDA_FIM":16127,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/volleyball-nations-league/2023/schedule/"},
                         {"COMPETICAO":"VNL","ANO":2024,"CATEGORIA":"F","PARTIDA_INI":18957,"PARTIDA_FIM":19060,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/volleyball-nations-league/2024/schedule/"},
                         {"COMPETICAO":"VNL","ANO":2025,"CATEGORIA":"F","PARTIDA_INI":21553,"PARTIDA_FIM":21668,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/volleyball-nations-league/schedule/"},
                         {"COMPETICAO":"WC","ANO":2022,"CATEGORIA":"F","PARTIDA_INI":13873,"PARTIDA_FIM":13972,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/women-world-championship/2022/schedule/"},
                         {"COMPETICAO":"WC","ANO":2025,"CATEGORIA":"F","PARTIDA_INI":22391,"PARTIDA_FIM":22454,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/women-world-championship/schedule/"},
                         {"COMPETICAO":"OG","ANO":2021,"CATEGORIA":"F","PARTIDA_INI":11382,"PARTIDA_FIM":11419,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/olympics-2020/schedule/"},
                         {"COMPETICAO":"OG","ANO":2024,"CATEGORIA":"F","PARTIDA_INI":19087,"PARTIDA_FIM":19112,"URL_BASE":"https://en.volleyballworld.com/volleyball/competitions/volleyball-olympic-games-paris-2024/schedule/"}]
    ...
    dados_defesa.to_csv('defesa.csv')
    dados_defesa.info()
    ...
    dados_bloqueio.to_csv('bloqueio.csv')
    dados_bloqueio.info()
    ...
    dados_recepcao.to_csv('recepcao.csv')
    dados_recepcao.info()
    ...
    dados_levantamento.to_csv('levantamento.csv')
    ...
    dados_ataque.to_csv('ataque.csv')
    dados_ataque.info()

    dados_partida_todas.to_csv('lista_jogos.csv')

    dados_partida_sets.to_csv('lista_jogos_sets.csv')
